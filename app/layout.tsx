...
export const metadata: Metadata = {
  ...
  description: "A powerful web application built with Next.js 15, TypeScript, Tailwind CSS, and shadcn/ui",
  ...
  openGraph: {
    ...
    siteName: "Klub",
    title: "Klub - Modern Web Application",
    description: "A powerful web application built with Next.js 15 and shadcn/ui",
    images: [
      {
